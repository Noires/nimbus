...
export const enC: Record<string, string> = {
  ...
  "c.selection.tidy": "Tidy selected",
  "c.selection.tidyPreview": "{moved} moved · {unchanged} unchanged · {skipped} skipped",
  "c.selection.tidySkippedMissing": "{count} missing task",
  "c.selection.tidySkippedProtectedTask": "{count} protected task",
  "c.selection.tidySkippedPinnedWorkstream": "{count} pinned workstream",
  "c.selection.tidySkippedProtectedWorkstream": "{count} protected workstream",
  "c.selection.applyTidy": "Apply tidy",
  "c.selection.applyZones": "Apply zone arrangement",
  "c.selection.cancelTidy": "Cancel",
  "c.selection.arrangeZones": "Arrange in zones",
  "c.selection.zonePreviewLabel": "Arrange selected tasks in zones",
  "c.selection.zonePreviewScope": "Selected scope: selected tasks",
  "c.selection.zoneSkippedOutside": "{count} outside a Zone",
  "c.selection.zoneSkippedAmbiguous": "{count} in overlapping Zones",
  "c.selection.zoneSkippedSmall": "{count} Zone too small",
  "c.selection.zoneNeedsEligible": "Select at least two eligible tasks in zones to arrange them.",
  "c.selection.zoneDetails": "Details",
  "c.selection.zoneMovedDetail": "{task} → {zone}",
  "c.selection.zoneUnchangedDetail": "{task} already in {zone}",
  "c.selection.zoneSkippedDetail": "{task}: {reason}",
  "c.selection.unnamedZone": "Unnamed Zone",
  "c.selection.untitledTask": "Untitled task",
  "c.selection.missingTask": "Missing task",
...
export const deC: Record<string, string> = {
  ...
  "c.selection.tidy": "Auswahl aufräumen",
  "c.selection.tidyPreview": "{moved} verschoben · {unchanged} unverändert · {skipped} übersprungen",
  "c.selection.tidySkippedMissing": "{count} fehlende Aufgabe",
  "c.selection.tidySkippedProtectedTask": "{count} geschützte Aufgabe",
  "c.selection.tidySkippedPinnedWorkstream": "{count} angehefteter Arbeitsstrom",
  "c.selection.tidySkippedProtectedWorkstream": "{count} geschützter Arbeitsstrom",
  "c.selection.applyTidy": "Aufräumen anwenden",
  "c.selection.applyZones": "Zonenanordnung anwenden",
  "c.selection.cancelTidy": "Abbrechen",
  "c.selection.arrangeZones": "In Zonen anordnen",
  "c.selection.zonePreviewLabel": "Ausgewählte Aufgaben in Zonen anordnen",
  "c.selection.zonePreviewScope": "Ausgewählter Bereich: ausgewählte Aufgaben",
  "c.selection.zoneSkippedOutside": "{count} außerhalb einer Zone",
  "c.selection.zoneSkippedAmbiguous": "{count} in überlappenden Zonen",
  "c.selection.zoneSkippedSmall": "{count} Zone zu klein",
  ...
  "c.selection.missingTask": "Fehlende Aufgabe",
