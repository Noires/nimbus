...
Command Center is the default Nimbus workspace on desktop and mobile. It does not require browser-local configuration; stale values from the retired rollout flag are ignored.
